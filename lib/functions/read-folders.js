...
function readFolders() {
    ...
    for (const [name, { path, exclude: configExclude }] of Object.entries(folders)) {
        ...
        if (!dirExists)
            logger_1.default.fatal(`Could not find ${path}! Please check your endpoint.config.json and make sure the path is relative to where the config file is and does not start with a /.`);
...
//# sourceMappingURL=read-folders.js.map